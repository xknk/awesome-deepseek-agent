...
| **DeepSeeker-Code** | DeepSeek 驱动的本地优先 AI 编码助手——一个 agentic 引擎共享 VS Code 插件、终端 CLI、本地 HTTP 服务三种入口。支持 DeepSeek-V4 全量 100 万 token 上下文、max 推理力度与 MCP / Hooks / Skills 扩展。 | [指南](./docs/deepseeker_code.zh-CN.md) |
